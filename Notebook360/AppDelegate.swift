...
@main
class AppDelegate: UIResponder, UIApplicationDelegate, KCLoginManagerDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if Singleton.shared.coreBooks.isEmpty {
            let cbook = DataManager.shared.coreBook(book: .init(id: UUID().uuidString, title: "HomeBook", bookIds: []))
